...
// package. It feeds writeStoreError a synthetic path-bearing error without
// standing up the full EncryptedStore + httptest.Server stack, alongside the
// existing end-to-end fixtures.
